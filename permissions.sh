...
%life_administradores	    ALL=(ALL) ALL, NOROOT
%life_operador  	    ALL=(ALL) ALL, NOROOT, !/sbin/shutdown, !/sbin/reboot, !/usr/bin/rm
%life_viewer		    ALL=(ALL) /usr/bin/cat, VIEW_IPTABLES, ASTERISK
